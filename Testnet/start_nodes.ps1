...
$node1Command = "..\hdchain.exe --datadir .\node1 --networkid 1337 --port 30306 --http --http.addr 0.0.0.0 --http.port 8547 --http.api eth,net,web3,txpool,debug,personal,admin,clique,poatc,miner --http.corsdomain * --http.vhosts * --ws --ws.addr 0.0.0.0 --ws.port 8548 --ws.api eth,net,web3,txpool,debug,personal,admin,clique,poatc,miner --ws.origins * --allow-insecure-unlock --syncmode full --mine --miner.etherbase 0x6519B747fC2c4DD4393843855Bef77f28875B07C --unlock 0x6519B747fC2c4DD4393843855Bef77f28875B07C --password .\node1\password.txt --ipcdisable --authrpc.port 8551"
...
$node2Command = "..\hdchain.exe --datadir .\node2 --networkid 1337 --port 30307 --http --http.addr 127.0.0.1 --http.port 8549 --http.api eth,net,web3,txpool,debug,personal,admin,clique,poatc,miner --http.corsdomain * --http.vhosts * --ws --ws.addr 127.0.0.1 --ws.port 8550 --ws.api eth,net,web3,txpool,debug,personal,admin,clique,poatc,miner --ws.origins * --allow-insecure-unlock --syncmode full --mine --miner.etherbase 0x89aEae88fE9298755eaa5B9094C5DA1e7536a505 --unlock 0x89aEae88fE9298755eaa5B9094C5DA1e7536a505 --password .\node2\password.txt --ipcdisable --authrpc.port 8552 --bootnodes enode://31434a17a397da092908012a3e62daf495b8316b2eb8b4e03125607ef4d2d274f84530ab5ae67d4dbfc369358bf1f728e54ce7213d6623886f1c71b7abc81454@127.0.0.1:30306"
